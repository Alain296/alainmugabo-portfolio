...
const projects: Record<string, Project> = {
  ...
  "myjudicial-frontend": {
    ...
    shortDescription: "React + Tailwind frontend for a digital judicial platform",
    fullDescription: "MyJudicial Frontend is the client application of the MyJudicial platform, a digital judicial case management system. It allows citizens, lawyers and court officers to submit new cases, follow their status in real time, upload supporting documents and communicate with assigned officers. The interface is built with React and Tailwind CSS for a clean, responsive experience across desktop and mobile devices, and consumes the MyJudicial REST API.",
    technologies: [
      { name: "React", icon: Layout },
    ...
    features: [
      "Case submission and tracking dashboards",
      "Role-based interfaces for citizens, lawyers and judges",
      "Document upload and preview",
      "Responsive UI built with Tailwind CSS",
      "Authentication and protected routes",
      "Integration with the MyJudicial REST API",
    ],
    github: "https://github.com/My-Judicial/myjudicial-frontend",
    image: myjudicialImage,
    gallery: [myjudicialImage, myjudicialImage, myjudicialImage],
    category: "Full-Stack Web Application",
  },
  "myjudicial-backend": {
    id: "myjudicial-backend",
    title: "MyJudicial Backend",
    shortDescription: "Node.js/Express API powering the MyJudicial platform",
    fullDescription: "MyJudicial Backend is the server-side of the MyJudicial digital court platform. Built with Node.js and Express, it exposes a documented REST API for case management, user authentication, role-based access control (citizens, lawyers, judges, admins) and secure document handling. Data is stored in MongoDB and endpoints are protected with JWT-based authentication, making the API safe to consume from the web and future mobile clients.",
    technologies: [
      { name: "Node.js", icon: Server },
      { name: "Express", icon: Code2 },
      { name: "MongoDB", icon: Database },
    ...
    features: [
      "RESTful API for judicial case workflows",
      "JWT authentication and role-based authorization",
      "Case, user and document data models",
